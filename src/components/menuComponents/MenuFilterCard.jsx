...
function MenuFilterCard(props) {
  return (
      <>
        ...
        <div onClick={props.onClick} className='flex flex-col gap-2 w-[10%] h-[150px] menuFilterContainer items-center  rounded-lg  border-[1px]  ml-[2vh] shadow-lg shadow-gray-600 bg-white transition transform hover:scale-105 duration-300'>
